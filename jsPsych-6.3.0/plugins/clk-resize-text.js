...
jsPsych.plugins['clk-resize-text'] = (function() {
  ...
  plugin.info = {
    ...
    parameters: {
      ...
      resize_button_label: {
        type: jsPsych.plugins.parameterType.STRING,
        pretty_name: 'Resize label',
        default: 'Resize',
        array:false,
        description: 'Label of the button to resize text.'
      },
      prompt: {
        type: jsPsych.plugins.parameterType.STRING,
        pretty_name: 'Prompt',
  ...
  plugin.trial = function(display_element, trial) {
    ...
    // add submit button
    html += '<button id="clk-resize-text-resize" class="jspsych-btn">'+trial.resize_button_label+'</button>'
    ...
    display_element.querySelector('#clk-resize-text-resize').addEventListener('click', function() {
      response.fontsize = display_element.querySelector('#jspsych-html-slider-response-response').value
      document.body.style.fontSize = response.fontsize + "px"
