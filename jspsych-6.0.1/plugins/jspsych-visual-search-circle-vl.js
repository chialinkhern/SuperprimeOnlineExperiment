...
jsPsych.plugins["visual-search-circle-vl"] = (function() {
  ...
  plugin.info = {
    ...
    parameters: {
      ...
      pos: {
        ...
        default: 'L',
        description: 'Position of the flanker'
      },
      fixation_image: {
        type: jsPsych.plugins.parameterType.IMAGE,
  ...
  plugin.trial = function(display_element, trial) {
    ...
    function show_search_array() {
      ...
      paper.innerHTML += "<img src='"+trial.flanker+"' style='position: absolute; top:"+((diam/2)-20)+"px; left:"+pos+"px; width:"+75+"px; height:"+90+"px;'></img>";
